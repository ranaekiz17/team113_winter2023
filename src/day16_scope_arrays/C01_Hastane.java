...
public class C01_Hastane {
    ...
    public static void main(String[] args) {
        ...
        ADoktor dok1 = new ADoktor();                                                          // Scanner gibi
        ...
        System.out.println(dok3.fakulte); // Tip fakulte                  // fakulte static oldugu icin atama yapilmasa
                                                                                // bile degismez

        System.out.println(ADoktor.fakulte);
        // static variable lar icin tavsiye edilen erisim yontemi
        // classİsmi.staticUyeİsmi seklinde yazimdir
